...
export default function AccommodationsPage() {
  ...
  }, [searchParams, filters, currentPage, isAuthenticated, isLoading, user, router]);
  ...
  }, [searchParams, filters.min_price, filters.max_price]);
    ...
    <div className="min-h-screen">
      ...
      <main className="container mx-auto px-4 py-6 md:py-8 max-w-7xl">
        <div className="flex items-center justify-between mb-4 md:mb-6">
          <h1 className="text-2xl md:text-3xl font-bold">Hébergements</h1>
          {/* Bouton filtre mobile */}
          <button
            onClick={() => setMobileFiltersOpen(!mobileFiltersOpen)}
            className="md:hidden flex items-center gap-2 px-4 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-full shadow-sm text-sm font-medium"
          >
        ...
        {/* Recherche et filtres - toujours visibles sur desktop, toggle sur mobile */}
