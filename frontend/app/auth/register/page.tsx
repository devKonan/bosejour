    ...
    <div className="min-h-screen">
      ...
      <main className="container mx-auto px-4 py-6 sm:py-12">
        <div className="max-w-2xl mx-auto">
          <h1 className="text-2xl sm:text-3xl font-bold mb-6 sm:mb-8 text-center break-words">Créer mon espace</h1>
            ...
            <div className="card">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 sm:mb-6 gap-2">
                <h2 className="text-lg sm:text-2xl font-bold break-words">
                  Création de mon espace en tant que {selectedRole === 'user' ? 'Voyageur' : 'Propriétaire'}
                </h2>
                <button
                  onClick={() => {
